...
| `catalog`  | `category` (ltree `path`), `brand`, `brand_alias`, `option_type`, `option_value`, `value_set`, `value_set_item`, `category_option`, `outbox` — more entities land one at a time     |
